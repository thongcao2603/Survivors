...
public class CharacterScriptableObject : ScriptableObject
{
    ...
    {
        get => startingWeapon; private set => startingWeapon = value;
    }
    ...
    {
        get => recovery; private set => recovery = value;
    }
    ...
    public float Might
    {
        get => might; private set => might = value;
    }

    [SerializeField] float projectileSpeed;
    public float ProjectileSpeed
    {
        get => projectileSpeed; private set => projectileSpeed = value;
    }

    [SerializeField] float magnet;
    public float Magnet
    {
        get => magnet; private set => magnet = value;
    }
